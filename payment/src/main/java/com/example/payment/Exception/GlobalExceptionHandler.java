...
import com.example.payment.Utility.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<SimpleErrorResponse> handleResourceFoundException(
        ...
        return ResponseBuilder.failure(HttpStatus.FOUND, response);
    }
